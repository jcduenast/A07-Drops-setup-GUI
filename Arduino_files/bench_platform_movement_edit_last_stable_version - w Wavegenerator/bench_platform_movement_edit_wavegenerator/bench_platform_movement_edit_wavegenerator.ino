...
float cfcXW=0.3759398;  // new
float cfcYW=0.3759398;  // new
float cfcZW=0.7462686;  // new
...
long TravelXW;                    // Used to store the XW value entered in the Serial Monitor (new)
long TravelYW;                    // Used to store the YW value entered in the Serial Monitor (new)
long TravelZW;                    // Used to store the ZW value entered in the Serial Monitor (new)
...
void setup() {
 ...
 pinMode(62, OUTPUT);
  ...
  stepperYW.setMaxSpeed(1000.0);      // Set Max Speed of Stepper (Faster for regular movements)
  stepperYW.setAcceleration(100.0);   // Set Acceleration of Stepper*/
